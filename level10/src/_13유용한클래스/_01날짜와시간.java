...
public class _01날짜와시간 {
	public static void main(String[] args) {
		...
		// 두 날짜 사이의 간격을 각각 년/월/일로 표시
		LocalDate test1 = LocalDate.of(2030, 5, 5);
		Period test = Period.between(test1, today);
		System.out.println(test.getYears());
		System.out.println(test.getMonths());
		System.out.println(test.getDays());
		
		// 두 날짜 사이의 간격을 일 시 분 초 단위로 각각 환산
		...
		System.out.println(test3.toMillis());	// 밀리초 10 -3승
		System.out.println(test3.toNanos());	// 나노초 10 -9승
